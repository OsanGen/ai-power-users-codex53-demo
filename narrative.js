window.AI_POWER_USER_NARRATIVE = {
  ...
  ui: {
    ...
    appFooterMusicUnmuteAction: "Unmute music",
    appFooterSfxHintKey: "E",
    appFooterSfxHintAction: "Mute sound effects",
    appFooterSfxUnmuteAction: "Unmute sound effects",
    ...
    hudMusicOnCompact: "Music: On",
    hudMusicOffCompact: "Music: Off",
    hudMusicUnavailableCompact: "Music unavailable",
    ...
    runSummaryFloorsCleared: "Floors cleared",
    runSummaryUpgradesTaken: "Upgrades taken",
    ...
    rearHintDualBody: "{seconds}s hold: shots fire forward and backward.",
    rearHintOmniTitle: "Omni burst unlocked",
    rearHintOmniBody: "{seconds}s hold: shots fire in all 4 directions.",
